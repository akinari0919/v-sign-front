<template>
  <v-card>
    ...
    <v-card-text>
      <p>
        この利用規約（以下、「本規約」といいます。）は、本ウェブサイトの管理者（以下，「管理者」といいます。）が
      ...
      <p>
        <ol>
          ...
          <li>
            管理者は、本サービスに関し、本規約のほか、ご利用にあたってのルール等、各種の定め（以下、「個別規定」といいます。）をすることがあります。
      ...
      <p>
        <ol>
          <li>
            本サービスにおいては登録希望者が本規約に同意の上、管理者の定める方法によって利用登録を申請し、管理者がこれを承認することによって利用登録が完了するものとします。
          </li>
          <li>
      ...
      <p>
        <ol>
          <li>
            管理者は、本サービスに事実上または法律上の瑕疵（安全性、信頼性、正確性、完全性、有効性、特定の目的への適合性、
            セキュリティなどに関する欠陥、エラーやバグ、権利侵害などを含みます。）がないことを明示的にも黙示的にも保証しておりません。
          </li>
          <li>
            管理者は、以下について一切の責任を負いません。
            <ul>
              <li>
                Webカメラで撮影した画像の視聴に使用するＰＣ、スマートフォン等の利用環境について生じた一切の不具合
              </li>
              <li>
                Webカメラの利用により利用者の発電設備およびその周辺機器に生じた不具合
              </li>
              <li>
                Webカメラの利用により利用者の発電設備およびその周辺機器に生じた不具合
              </li>
              <li>
                その他、本サービスに起因してユーザーに生じたあらゆる損害
              </li>
            </ul>
          </li>
        </ol>
      ...
      <p>
        管理者は、ユーザーに通知することなく、本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし、
